...
基于本研究的实验结果与局限性，后续可从以下方面继续改进：

\begin{enumerate}[itemsep=0pt, parsep=0pt, topsep=0pt, partopsep=0pt]
    \item 确定性信号方法在旋转手势（AR/CR）上准确率较低，原因是旋转运动产生的相位曲线非单调，不具备确定性极值时序特征。可尝试将幅度包络特征与相位特征结合，扩展到旋转类手势的识别。
    \item 当前数据集规模较小（每类约50--60样本），限制了CNN和LSTM的泛化能力。扩充受试者数量和手势变体，有助于提升深度学习方法的跨用户稳定性。
    \item 5.8\,GHz的波长约5.2\,cm，与手掌尺寸相当，处于米氏散射敏感区，对手掌姿态变化敏感。引入更高频段（如24\,GHz）可缩短波长、降低散射对角度的敏感性，有望改善对细粒度手势的识别效果。
\end{enumerate}
